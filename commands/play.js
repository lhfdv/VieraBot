      ...
      if (search.match(client.Lavasfy.spotifyPattern)) {
        ...
        switch (Searched.loadType) {
          ...
          case "TRACK_LOADED":
            ...
            return interaction.send(SongAddedEmbed).then(interaction => {interaction.delete(30000)});
        ...
        switch (res.loadType) {
          ...
          case "SEARCH_RESULT":
            ...
            if (!player.playing && !player.paused && !player.queue.length) {
              ...
              interaction.send(SongAddedEmbed).then(interaction => {interaction.delete(30000)});
            }
        }
      }
    },
